...
set key left Left reverse spacing 2.0 font "Times, 24"

plot [0:rhomax][0:28] \
  "../../data/hs/muhshnccv.dat" u 1:3 w l ls 7 t "{/Symbol-Oblique b m}@_{/Times-Italic c}^{ex}, Reference", \
  ...
  "../../data/hs/muhshnccv.dat" u 1:14 every 5 w p ls 3 t "{/Symbol-Oblique b m}@_{/Times-Italic v}^{ex}, {/Times-Italic B} = {/Symbol D} = 0", \
  "../../data/hs/muhshncxir.dat" u 1:3 every 5::4 w p ls 5 t "{/Symbol-Oblique b m}@_{{/Symbol-Oblique x}{/Times-Italic r}}^{ex} , Reference", \
  "../../data/hs/muhshnclamc.dat" u 1:3 every 5::4 w p ls 11 t "{/Symbol-Oblique b m}@_{{/Symbol-Oblique l}{/Times-Italic c}}^{ex} , Reference", \
