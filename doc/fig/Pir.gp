...
plot [:0.7][:] \
  ...
  "../../data/iemuhsirscp.dat"    u 1:22  w p   ls 1 t "Eq. (24), {/Symbol-Oblique q} = 0", \
  "../../data/iemuhsirscp.dat"    u 1:23  w p   ls 2 t "Eq. (24), {/Symbol-Oblique q} = 1/2", \
  "../../data/iemuhsirscp.dat"    u 1:24  w p   ls 3 t "Eqs. (24) and (26)", \
  "../../data/iemuhsirscp.dat"    u 1:26  w p   ls 4 t "Eq. (27)", \
