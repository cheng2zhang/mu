...
plot [0:rhomax][0:21] \
  "../../data/hs/muhshccv.dat" u 1:3 w l ls 7 t "{/Symbol-Oblique b m}@_{/Times-Italic c, v}^{ex}, Reference", \
  ...
  "../../data/hs/muhshcxir.dat" u 1:3 w l ls 9 t "{/Symbol-Oblique b m}@_{{/Symbol-Oblique x}{/Times-Italic r}}^{ex}, Reference", \
  "" u 1:9 every 5 w p ls 5 t "{/Symbol-Oblique b m}@_{{/Symbol-Oblique x}{/Times-Italic r}}^{ex}, {/Symbol D} = {/Times-Italic h B}", \
  "" u 1:11 every 5 w p ls 6 t "{/Symbol-Oblique b m}@_{{/Symbol-Oblique x}{/Times-Italic r}}^{ex}, {/Symbol D} = {/Times-Italic -B}", \
